...
import app.campfire.search.ui.composables.BasicSearchResultChip
...
interface DockedSearchBarComponent {
...
fun CampfireDockedSearchBar(
  ...
  component: DockedSearchBarComponent = rememberComponent(),
) {
  val presenter = remember(component, navigator) { component.searchPresenterFactory(navigator) }
