...
data class EreaderDeviceObject (
    ...
    enum class AvailabilityOption(val value: kotlin.String) {
        @SerialName(value = "adminOrUp") AdminOrUp("adminOrUp"),
        @SerialName(value = "userOrUp") UserOrUp("userOrUp"),
        @SerialName(value = "guestOrUp") GuestOrUp("guestOrUp"),
        @SerialName(value = "specificUsers") SpecificUsers("specificUsers");
    }
