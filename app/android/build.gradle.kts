...
import app.campfire.convention.normalizeFossReleasePgMapId
...
// Normalize R8's pg-map-id in the foss release DEX so F-Droid's rebuild is byte-identical to ours.
normalizeFossReleasePgMapId()
