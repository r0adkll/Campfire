...
import app.campfire.themes.SelectAll
import app.campfire.themes.SelectById
import app.campfire.ui.theming.api.AppTheme

fun SelectAll.asDomainModel(): AppTheme.Fixed {
  if (isAi) {
    return AppTheme.Fixed.Ai(
      id = id,
      name = name,
      icon = icon,
      prompt = prompt!!,
    ...
    return AppTheme.Fixed.Custom(
      ...
      contrastLevel = contrastLevel.toFloat(),
      colorPalette = colorPalette(),
    )
  }
}

fun SelectAll.colorPalette(): ColorPalette {
  return ColorPalette(
...
fun SelectById.asDomainModel(): AppTheme.Fixed {
  if (isAi) {
    return AppTheme.Fixed.Ai(
      id = id,
      name = name,
...
fun SelectById.colorPalette(): ColorPalette {
  return ColorPalette(
    lightColorScheme = ColorScheme(
      light_primaryColor,
      light_onPrimary,
