...
internal val DarkColorTint = Color(0xFF333333)

@Composable
fun rememberTentVectorPainter(
  lightColor: Color = MaterialTheme.colorScheme.primary,
  darkColor: Color = lightColor.copy(0.5f).compositeOver(DarkColorTint),
