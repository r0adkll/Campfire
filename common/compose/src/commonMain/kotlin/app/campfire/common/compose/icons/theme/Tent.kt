...
internal val SourceColor = Color(0xFFFD3C4F)
internal val SecondaryColor = Color(0xFFFFC536)

val CampfireIcons.Theme.Tent: ImageVector by lazy(LazyThreadSafetyMode.PUBLICATION) {
  ImageVector.Builder(
    name = "TentRed",
    defaultWidth = 64.dp,
    defaultHeight = 64.dp,
