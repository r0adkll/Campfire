...
private var _TentOrange: ImageVector? = null

val CampfireIcons.Tents.Orange: ImageVector
  get() {
    if (_TentOrange != null) {
      return _TentOrange!!
    }
    _TentOrange = ImageVector.Builder(
      name = "TentOrange",
      defaultWidth = 64.dp,
      defaultHeight = 64.dp,
      viewportWidth = 64f,
      ...
      path(
        fill = SolidColor(Color(0xFFFD873C)),
        fillAlpha = 1.0f,
        stroke = null,
        strokeAlpha = 1.0f,
        strokeLineWidth = 1f,
      ...
      path(
        fill = SolidColor(Color(0xFFA64B18)),
        fillAlpha = 1.0f,
        stroke = null,
        strokeAlpha = 1.0f,
        strokeLineWidth = 1f,
