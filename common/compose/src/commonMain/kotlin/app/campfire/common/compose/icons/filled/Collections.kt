...
private var _CollectionsFilled: ImageVector? = null

public val Icons.Filled.Collections: ImageVector
  get() {
    if (_CollectionsFilled != null) {
      return _CollectionsFilled!!
    }
    _CollectionsFilled = ImageVector.Builder(
      ...
      path(
        ...
        moveTo(13.75f, 10.55f)
        lineTo(15.5f, 9.5f)
        lineTo(17.25f, 10.55f)
        curveTo(17.4167f, 10.65f, 17.5833f, 10.65f, 17.75f, 10.55f)
        curveTo(17.9167f, 10.45f, 18f, 10.3083f, 18f, 10.125f)
        verticalLineTo(4f)
        horizontalLineTo(13f)
        verticalLineTo(10.125f)
        curveTo(13f, 10.3083f, 13.0833f, 10.45f, 13.25f, 10.55f)
        curveTo(13.4167f, 10.65f, 13.5833f, 10.65f, 13.75f, 10.55f)
        close()
        moveTo(8f, 18f)
