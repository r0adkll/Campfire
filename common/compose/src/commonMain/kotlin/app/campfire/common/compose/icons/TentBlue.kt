...
private var _TentBlue: ImageVector? = null

val CampfireIcons.Tents.Blue: ImageVector
  get() {
    if (_TentBlue != null) {
      return _TentBlue!!
    }
    _TentBlue = ImageVector.Builder(
      name = "TentBlue",
      defaultWidth = 64.dp,
      defaultHeight = 64.dp,
      viewportWidth = 64f,
      ...
      path(
        fill = SolidColor(Color(0xFF3C9EFD)),
        fillAlpha = 1.0f,
        stroke = null,
        strokeAlpha = 1.0f,
        strokeLineWidth = 1f,
      ...
      path(
        fill = SolidColor(Color(0xFF1847A6)),
        fillAlpha = 1.0f,
        stroke = null,
        strokeAlpha = 1.0f,
        strokeLineWidth = 1f,
