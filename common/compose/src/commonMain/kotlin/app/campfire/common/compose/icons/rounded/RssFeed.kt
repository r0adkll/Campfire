...
val CampfireIcons.Rounded.RssFeed: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
  ImageVector.Builder(
    name = "RssFeed",
    defaultWidth = 24.dp,
    defaultHeight = 24.dp,
    ...
    path(fill = SolidColor(Color.Black)) {
      moveTo(143.5f, 816.5f)
      quadTo(120f, 793f, 120f, 760f)
      reflectiveQuadToRelative(23.5f, -56.5f)
      quadTo(167f, 680f, 200f, 680f)
      reflectiveQuadToRelative(56.5f, 23.5f)
      quadTo(280f, 727f, 280f, 760f)
      reflectiveQuadToRelative(-23.5f, 56.5f)
      quadTo(233f, 840f, 200f, 840f)
      reflectiveQuadToRelative(-56.5f, -23.5f)
      close()
      moveTo(740f, 840f)
