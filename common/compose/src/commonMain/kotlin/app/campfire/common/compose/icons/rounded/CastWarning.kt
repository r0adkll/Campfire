...
val CampfireIcons.Rounded.CastWarning: ImageVector
  get() {
    if (_CastWarning != null) {
      return _CastWarning!!
    }
    _CastWarning = ImageVector.Builder(
      name = "Rounded.CastWarning",
      defaultWidth = 24.dp,
      defaultHeight = 24.dp,
      viewportWidth = 960f,
      viewportHeight = 960f,
...
private var _CastWarning: ImageVector? = null
